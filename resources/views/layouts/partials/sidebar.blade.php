    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                @can('measurement-units.view')
                    <li class="nav-item {{ request()->routeIs('measurement-units.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('measurement-units.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><i class="ti ti-ruler-measure"></i></span>
                ...
                @can('inventory.view')
                    <li class="nav-item {{ request()->routeIs('inventory.index') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('inventory.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><i class="ti ti-transfer"></i></span>
                ...
                @can('suppliers.view')
                    <li class="nav-item {{ request()->routeIs('suppliers.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('suppliers.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><i class="ti ti-truck-delivery"></i></span>
                    ...
                    @can('roles.view')
                        <li class="nav-item {{ request()->routeIs('roles.*') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('roles.index') }}">
                                <span class="nav-link-icon d-md-none d-lg-inline-block"><i class="ti ti-lock-access"></i></span>
                ...
                <li class="nav-item app-menu-label">
                    <span class="nav-link disabled">
                        <span class="nav-link-title">Operaciones futuras</span>
                    </span>
                </li>
                @can('purchases.view')
                ...
                @else
                    <li class="nav-item"><span class="nav-link disabled"><span class="nav-link-icon"><i class="ti ti-shopping-cart"></i></span><span class="nav-link-title">Compras</span></span></li>
                @endcan
                @can('sales.view')
